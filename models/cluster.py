...
from data.load import dfi
from data.load import dfs
from data.load import dfp
from data.load import dfmlle 
...
datasetname = ['isomap', 'spectral', 'pca', 'mlle']
for i_dataset, dataset in enumerate(datasets):
    ...
    for i_num, (method, algorithm) in enumerate(zip(clustering_names, clustering_algorithms)):
        ...
        if i_num == 0:
            plt.ylabel(datasetname[i_dataset], size=18)
